...
import { CONNECTOR_COLORS, connectorColor, findTheme, getTheme, UI_THEMES } from "../src/ui/theme.js";
...
test("connector 표식에 Instagram과 KakaoTalk 브랜드 색을 제공한다", () => {
  ...
  assert.equal(CONNECTOR_COLORS.discord, "#5865F2");
  assert.equal(connectorColor("discord", "#000000"), "#5865F2");
  assert.equal(connectorColor("unknown", "#000000"), "#000000");
});
